...
static void camera_video_frame_operation(uint8_t *camera_buf, uint8_t camera_buf_index, uint32_t camera_buf_hes, uint32_t camera_buf_ves, size_t camera_buf_len, void *user_data)
{
    ...
    ppa_srm_oper_config_t srm_config = {
        ...
        .in.block_w = 1280,
        .in.block_h = 800,
        // .in.block_offset_x = (camera_buf_hes > EXAMPLE_LCD_V_RES) ? (camera_buf_hes - EXAMPLE_LCD_V_RES) / 2 : 0,
        // .in.block_offset_y = (camera_buf_ves > EXAMPLE_LCD_H_RES) ? (camera_buf_ves - EXAMPLE_LCD_H_RES) / 2 : 0,
        .in.block_offset_x = 0,
        .in.block_offset_y = 0,
